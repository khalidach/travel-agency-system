...
import { Plus, Edit2, Trash2, CreditCard, User, Calendar, DollarSign, MapPin, Hotel } from 'lucide-react';
...
export default function BookingPage() {
  ...
  const handleSaveBooking = (booking: Booking) => {
    if (editingBooking) {
      ...
      dispatch({ type: 'ADD_BOOKING', payload: { ...booking, id: Date.now().toString() } });
    }
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredBookings.map((booking) => {
                const program = state.programs.find(p => p.id === booking.tripId);
                  ...
                  <tr key={booking.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-gray-500">
                          Remaining: {booking.remainingBalance.toLocaleString()} MAD
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
