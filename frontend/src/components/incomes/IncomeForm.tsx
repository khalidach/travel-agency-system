// frontend/src/components/incomes/IncomeForm.tsx
...
interface IncomeFormProps {
    initialData?: Income;
    onSubmit: (data: Partial<Income> & { paymentMethod?: PaymentMethod }) => void;
    onCancel: () => void;
}
...
export default function IncomeForm({
    ...
    // Example list, could be adapted for Income
    const categories = [
        "consulting",
        "sales",
        "services",
    ...
    const paymentMethods: { value: PaymentMethod; label: string }[] = [
        ...
        { value: "transfer", label: t("bank_transfer") || "Bank Transfer" },
