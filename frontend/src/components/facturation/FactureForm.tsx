  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className={labelClass}>{t("factureNumber", { defaultValue: "N° of document" })}</label>
          {existingFacture ? (
              <input
                type="text"
            ...
            <div className="relative flex mt-1">
              ...
              <input
                ...
                className="flex-1 block w-full px-3 py-2 rounded-none rounded-r-md border border-input bg-background text-foreground focus:ring-1 focus:ring-ring focus:border-ring placeholder:text-muted-foreground/50"
              />
            </div>
          )}
        </div>
